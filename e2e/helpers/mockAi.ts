...
export const AI_FIXTURES = {
  ...
  proposal: {
    ...
    trainingModules: [
      ...
      {
        code: "Б2",
        title: "Надежная работа с ИИ",
        hours: 4,
        image: "/images/photo_2026-07-17_4.jpg",
        reason: "Проверка результатов, данные и безопасность.",
      },
      {
        code: "П6",
        ...
        reason: "Закрывает вашу задачу по КП и работе с клиентами.",
      },
    ],
    totalHours: 12,
    ...
    trainingCost: {
      lines: [
        {
          label:
            "Пакет «Профессиональный» — Б1 + Б2 + один профессиональный трек (12 ак. часов × 250 BYN/ч, группа до 25 человек)",
          amount: 3000,
        },
      ],
      total: 3000,

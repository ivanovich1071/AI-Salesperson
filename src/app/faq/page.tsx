 ...
 *
 * Верстка на <details> — без клиентского JS: краулер видит ответы в HTML даже
 * со свернутыми блоками.
 */
...
export const metadata: Metadata = {
  ...
  description:
    "Где заказать внедрение ИИ в Беларуси, что входит в корпоративный курс по нейросервисам, кто его ведет и как считается стоимость обучения.",
  openGraph: {
    type: "website",
    title: "Вопросы и ответы о внедрении ИИ | ВайбМайнд",
    description:
      ...
      <div className="mx-auto max-w-3xl px-5 py-16">
        ...
        <div className="mt-14 rounded-3xl border border-teal/15 bg-white/80 p-8 text-center">
          ...
          <p className="mt-3 text-graphite/75">
            AI-диагностика задаст несколько вопросов, соберет программу под роли

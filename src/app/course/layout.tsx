...
export const metadata: Metadata = {
  ...
  description:
    "Авторский курс для организаций по нейросервисам и ИИ от Вероники Пунчик. AI-диагностика подберет программу под роли ваших сотрудников.",
  keywords: [
  ...
  return (
    <>
      {/* Программа, модули и квалификация автора — то, что ИИ-поисковик
          цитирует в ответе на «кто ведет курс по ИИ для организаций» */}
      <JsonLd
        data={graph(
          courseLd(),
          personLd(),

...
/**
 * Базовый адрес сайта берем из общего профиля (`src/lib/seo/profile.ts`) — тем же
...
export const metadata: Metadata = {
  ...
  description:
    "ВайбМайнд — белорусская компания: помогаем разобраться, где ИИ действительно полезен, обучаем команды и создаем ИИ-решения. Корпоративный курс по нейросервисам.",
  ...
  openGraph: {
    ...
    title: "ВайбМайнд — внедрение ИИ в организациях",
    description:
      "Помогаем специалистам и командам применять ИИ в реальной работе. Готовые AI-решения и корпоративный курс.",
    images: [OG_IMAGE],
  },
  twitter: {
    ...
    title: "ВайбМайнд — внедрение ИИ в организациях",
    description:
      "Помогаем специалистам и командам применять ИИ в реальной работе. Готовые AI-решения и корпоративный курс по нейросервисам.",
    images: [OG_IMAGE.url],
  },
  /**
    ...
    <html lang="ru">
      <head>
        {/* Кто мы и что это за сайт — фактура для ИИ-поисковиков на каждой странице.
            Разметка конкретного контента (решения, курс, FAQ) живет в layout-ах разделов. */}

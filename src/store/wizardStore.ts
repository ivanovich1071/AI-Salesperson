...
const GREETING: ChatMessage = {
  id: "greeting",
  kind: "ai",
  text: "👋 Здравствуйте! Я AI-ассистент компании ВайбМайнд. Помогу подобрать идеальную программу корпоративного обучения по ИИ для вашей команды. Заполните форму справа — и начнем.",
};
...
export const useWizardStore = create<WizardState>()(
  persist(
    ...
    }),
    {
      ...
      // помодульной схеме, показывать нельзя: цифры в нем уже неверные.
      version: 2,
